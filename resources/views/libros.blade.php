...
@section('content')
  <div id="container_libros" class="container_libros container">
        ...
        <div class="col-md-2">
          <div class="libros__item">
            <a href="{{route('libro', [$libro->libros_id])}}">
              <img id="{{$libro['libros_id']}}" class="libros__img" src="/assets/images/libros/{{$libro['libros_id']}}/{{$libro['libros_id']}}_x300.jpg">
            </a>
          </div>
        </div>
        <div class="col-md-4">
          ...
          <form id="librosCartForm{{$libro->libros_id}}" action="{{url('cart')}}">
...
<script>
  $(document).ready(function () {
    $('#container_libros form').each(function() {
